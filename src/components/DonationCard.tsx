      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-center">
          ...
          <Dialog>
            ...
            <DialogContent className="glassmorphism border-green-500/20 max-w-md">
              <DialogHeader>
              ...
              <div className="space-y-6 p-2">
                ...
                {/* Amount Selection */}
                <div>
                  <label className="block text-white mb-3">مبلغ حمایت را انتخاب کنید:</label>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full p-3 bg-gray-800/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-green-500"
                    />
                ...
                {/* Message */}
                <div>
                  <label className="block text-white mb-2">پیام برای هنرمند (اختیاری):</label>
                  <textarea
                    value={message}
                    onChange={(e) => setMessage(e.target.value)}
                    placeholder="پیام تشویقی یا نظرتان را بنویسید..."
                    rows={3}
                    className="w-full p-3 bg-gray-800/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-green-500 resize-none"
                  />
                </div>
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 disabled:opacity-50"
                >
